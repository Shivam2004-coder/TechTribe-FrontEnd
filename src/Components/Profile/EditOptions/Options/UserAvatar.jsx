                  ...
                  <div className="avatar border border-white h-10 rounded-full">
                      <div className="w-10 rounded-full">
                        ...
                        <div className="w-full h-full object-cover rounded-lg" >
                            <AdvancedImage cldImg={cld.image("boyAvatar1_k6nddv").resize(fill().width(250).height(250))} />
                        </div>
                      </div>
                  </div>
                  <div className="avatar border border-white h-10 rounded-full">
                      <div className="w-10 rounded-full">
                        ...
                        <div className="w-full h-full object-cover rounded-lg" >
                            <AdvancedImage cldImg={cld.image("boyAvatar2_ilignp").resize(fill().width(250).height(250))} />
                        </div>
                      </div>
                  </div>
                  <div className="avatar border border-white h-10 rounded-full">
                      ...
                      <div className="w-full h-full object-cover rounded-lg" >
                          <AdvancedImage cldImg={cld.image("boyAvatar3_ghehfe").resize(fill().width(250).height(250))} />
                      </div>
                      </div>
                  </div>
