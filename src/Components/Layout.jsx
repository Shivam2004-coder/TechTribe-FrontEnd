...
const Layout = () => {
    ...
    return (
        <div className="flex flex-col justify-between min-h-screen max-w-screen  bg-[#F5E1DA] bg-[radial-gradient(circle,_#000_1px,_transparent_1px)] [background-size:10px_10px]">
            <Header />
