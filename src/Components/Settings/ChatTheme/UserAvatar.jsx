                  ...
                  <div className="avatar border border-white h-10  md:h-13 rounded-md">
                      <div className="w-10  md:w-13 rounded-md">
                        ...
                        <div className="w-full h-full object-cover rounded-lg" >
                            <AdvancedImage cldImg={cld.image("ChatTheme6_xr2dqt").resize(fill().width(250).height(250))} />
                        </div>
                      </div>
                  </div>
                  <div className="avatar border border-white h-10  md:h-13 rounded-md">
                      <div className="w-10  md:w-13 rounded-md">
                        ...
                        <div className="w-full h-full object-cover rounded-lg" >
                            <AdvancedImage cldImg={cld.image("ChatTheme10_pu5goz").resize(fill().width(250).height(250))} />
                        </div>
                      </div>
                  </div>
                  <div className="avatar border border-white h-10  md:h-13 rounded-md">
                      ...
                      <div className="w-full h-full object-cover rounded-lg" >
                          <AdvancedImage cldImg={cld.image("ChatTheme3_d2szqb").resize(fill().width(250).height(250))} />
                      </div>
                      </div>
                  </div>
